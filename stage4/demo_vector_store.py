...
def demo_embedding_models():
    ...
    print("\nThen run:")
    print("  python stage4/scripts/build_vector_index.py --use-openai")
...
def main():
    ...
    if not os.path.exists("stage4/data/chroma"):
        print("\n⚠️  Vector index not found!")
        print("Please build the index first:")
        print("  python stage4/scripts/build_vector_index.py")
        return 1
    ...
    try:
        ...
        print("\nFor more information, see stage4/README.md")
        print("="*70 + "\n")
