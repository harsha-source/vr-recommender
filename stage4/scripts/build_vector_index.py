...
def main():
    ...
    parser.add_argument(
        "--skills",
        default="stage1/data/skills.json",
        help="Path to skills.json file (default: stage1/data/skills.json)"
    )
    parser.add_argument(
        "--persist-dir",
        default="stage4/data/chroma",
        help="Directory for ChromaDB persistence (default: stage4/data/chroma)"
    )
    parser.add_argument(
        "--use-openai",
        action="store_true",
