...
class TestNeo4jConnection(unittest.TestCase):
    ...
    @patch('stage3.src.knowledge_graph.connection.GraphDatabase')
    ...
    def test_connection_close(self):
        ...
        with patch('stage3.src.knowledge_graph.connection.GraphDatabase') as mock_graph_db:
            mock_driver = MagicMock()
            mock_graph_db.driver.return_value = mock_driver
...
class TestKnowledgeGraphBuilder(unittest.TestCase):
    ...
    @patch('stage3.src.knowledge_graph.builder.Neo4jConnection')
    ...
    @patch('stage3.src.knowledge_graph.builder.Neo4jConnection')
    @patch('stage3.src.knowledge_graph.builder.KnowledgeGraphSchema')
    @patch('stage3.src.knowledge_graph.builder.NodeCreator')
    @patch('stage3.src.knowledge_graph.builder.RelationshipCreator')
